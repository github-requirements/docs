...
Simply refer to the [React docs](/docs/docs/) if you need help executing this step.

### A Brief Interlude: Props vs State

There are two types of "model" data in React: props and state. It's important to understand the distinction between the two; skim [the official React docs](/docs/docs/interactivity-and-dynamic-uis.html) if you aren't sure what the difference is.
