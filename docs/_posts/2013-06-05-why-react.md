...
We've also created [JSX](/docs/docs/jsx-in-depth.html), an optional syntax
...
Head on over to [github-requirements.github.io/react](/react) to check out what we have
...
[get in touch](/docs/support.html) with us!
