...
At the React.js conference in late January 2015, we revealed our next major technology in the React family: [Relay](http://github-requirements.github.io/docs/blog/2015/02/20/introducing-relay-and-graphql.html). 
