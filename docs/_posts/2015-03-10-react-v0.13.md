...
[#3226](https://github.com/facebook/docs/issues/3226),
[#3227](https://github.com/facebook/docs/issues/3227),
[#3228](https://github.com/facebook/docs/issues/3228).
...
* Support for using ES6 classes to build React components; see the [v0.13.0 beta 1 notes](/docs/blog/2015/01/27/react-v0.13.0-beta-1.html) for details.
* Added new top-level API `React.findDOMNode(component)`, which should be used in place of `component.getDOMNode()`. The base class for ES6-based components will not have `getDOMNode`. This change will enable some more patterns moving forward.
* Added a new top-level API `React.cloneElement(el, props)` for making copies of React elements – see the [v0.13 RC2 notes](/docs/blog/2015/03/03/react-v0.13-rc2.html#react.cloneelement) for more details.
...
* [`React.addons.createFragment` was added](/docs/docs/create-fragment.html) for adding keys to entire sets of children.
