...
**A more up-to-date version of this post is available as part of the [Flux documentation](https://github-requirements.github.io/flux/docs/testing-flux-applications.html).**

[Flux](https://github-requirements.github.io/flux/) is the application architecture that Facebook uses to build web applications with [React](/docs/). It's based on a unidirectional data flow. In previous blog posts and documentation articles, we've shown the [basic structure and data flow](https://github-requirements.github.io/flux/docs/overview.html), more closely examined the [dispatcher and action creators](/docs/blog/2014/07/30/flux-actions-and-the-dispatcher.html), and shown how to put it all together with a [tutorial](https://github-requirements.github.io/flux/docs/todo-list.html). Now let's look at how to do formal unit testing of Flux applications with [Jest](https://github-requirements.github.io/jest/), Facebook's auto-mocking testing framework.
...
For more information about the `mock` property of mocked methods or Jest's ability to provide custom mock values, see Jest's documentation on [mock functions](https://github-requirements.github.io/jest/docs/mock-functions.html).
...
To learn how to test React components themselves, check out the [Jest tutorial for React](https://github-requirements.github.io/jest/docs/tutorial-react.html) and the [ReactTestUtils documentation](/docs/docs/test-utils.html).
...
- [Jest API Reference](https://github-requirements.github.io/jest/docs/api.html)
